  ...
  return (
    <div className='flex flex-row'>
      ...
      <div onClick={handleOpen}  className="relative flex-1  cursor-pointer bg-white shadow-1  border-b border-b-[whitesmoke] p-4 ">
           ...
           <div className='flex relative flex-row items-center justify-center  bg-white shadow-1 p-3 border-b ml-2 border-b-[whitesmoke]'>
        <p className='font-satoshi font-semibold text-[17px]'>Learning Path Recomendation</p>
        <div ref={trigger}
                onClick={() => setDropdownOpen(!dropdownOpen)} className="bg-[#25224A] text-white text-3xl ml-2  h-[35px] w-[35px] cursor-pointer rounded-[50%]  justify-center items-center flex">{email[0]}</div>
                 <div
        ref={dropdown}
        onFocus={() => setDropdownOpen(true)}
        onBlur={() => setDropdownOpen(false)}
        className={`absolute z-999999 right-2 top-22  flex w-72 flex-col rounded-xl border -mt-8 border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark ${
