    ...
    const handleSubmit=async()=>{
      ...
      if(Name===null||WebsietUrl===null||WebsiteN===null){
        ...
        setStateLoading(true)
          await axios.post(`https://interrective-demo-server.onrender.com/CreateSpace/${email}`,{
            Name:Name,
  ...
  return (
    <div>
        ...
        <div className='bg-white h-screen w-full flex items-center justify-center'>
            <div className='w-[700px]   bg-white rounded-lg shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] '>
                <div className="rounded-sm h-[600px] border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            <div className="border-b border-stroke py-4 px-6.5 dark:border-strokedark">
              ...
              <div className="p-6.5 relative">
                ...
                <button onClick={handleSubmit} type='submit' className="flex text-lg mt-14  w-full justify-center rounded-lg bg-[#25224A] p-4 font-semibold text-white">
                  {
              stateLoading?
             <DotLoader
              color="white"
